...
class SentimentClassifier(nn.Module):
    def __init__(self, n_classes, pre_trained_model_name='bert-base-uncased', dropout_prob=0.1):
        ...
        target_dim = self.bert_hidden_size + self.resnet_output_size  # 1280
    ...
    def forward(self, input_ids, attention_mask, image):
        ...
        text_features = bert_outputs.last_hidden_state  # [batch, seq_len, 768]
        
        resnet_features = self.resnet(image)  # [batch, 512]
        
        text_proj = self.bert_projection(text_features)  # [batch, seq_len, 1280]
        img_proj = self.resnet_projection(resnet_features)  # [batch, 1280]
        ...
        pooled_output = attn_output.mean(dim=0)  # [batch, 1280]
